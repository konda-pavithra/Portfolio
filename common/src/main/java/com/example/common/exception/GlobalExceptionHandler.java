...
// Shared across all services. Service-specific exceptions that need a richer response body
// (e.g. portfolio-service's StockAlreadyInPortfolioException) get their own additional
// @RestControllerAdvice alongside this one — Spring merges advice beans.
